  ...
  return (
    <section className="h-full">
      <div className="container mx-auto h-full px-4">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-4 xl:pb-20 pt-8 pb-12">
          <div className="text-center xl:text-left order-2 xl:order-none mb-6 xl:mb-0">
            ...
            <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 text-white/80 text-sm xl:text-base">
